...
const aboutContent: Record<AppLanguage, AboutContent> = {
  myanmar: {
    ...
    features: [
      ...
      'အသံထွက် (Pronunciation) လုပ်ဆောင်ချက် - စကားလုံးများကို အသံထွက်နိုင်ပြီး နားထောင်နိုင်ခြင်း',
      'လေ့လာသူများအတွက် အသုံးဝင်သော အသံထွက်များ၊ ဥပမာဝေါဟာရများ ထည့်သွင်းထားခြင်း',
      'Synonyms (အဓိပ္ပာယ်တူ) နှင့် Antonyms (ဆန့်ကျင်ဘက်) စကားလုံးများ ရှာဖွေနိုင်ခြင်း',
      'စကားလုံးရှာဖွေမှု အရှိန်မြှင့်တင်ရန် သုံးသပ်ချက်များနှင့် LEVELS များ ပံ့ပိုးပေးခြင်း',
      'အသုံးပြုသူများအနေနဲ့  စကားလုံးအသစ်များ (slangs) များကို Admin ခွင့်ပြုချက်ဖြင့်  APP Database သို့တိုက်ရိုက်ထည့်သွင်းနိုင်ခြင်း',
      'Quiz များ၊ Practice Sessions များဖြင့် ဘာသာစကားကျွမ်းကျင်မှု တိုးတက်စေရန် ကူညီပေးခြင်း',
      'TOPIK Test အစီစဉ်များ - TOPIK I (Level 1-2) နှင့် TOPIK II (Level 3-6) စမ်းသပ်မှုများ ပါဝင်ခြင်း',
      'Speaking Test အစီအစဉ်များဖြင့် စကားပြောနိုင်စွမ်း တိုးတက်စေရန် အခွင့်အရေးပေးခြင်း',
      'AI Chatbot နှင့် ဘာသာပြန်ဆိုမှု ဖန်ရှင်များ ပါဝင်ခြင်း',
  ...
  korean: {
    ...
    features: [
      ...
      '발음 기능 (Pronunciation) - 단어를 발음하고 들을 수 있습니다',
  ...
  english: {
    ...
    features: [
      ...
      'Pronunciation feature - Listen to and practice word pronunciations',
